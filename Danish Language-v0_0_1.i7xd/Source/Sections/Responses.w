...
=
The requested actions require persuasion rule response (A) is "[Substantivet] [har] bedre ting at gøre.". [ TODO ]
...
=
The parser nothing error internal rule response (C) is "[The noun] [have] nothing.".
